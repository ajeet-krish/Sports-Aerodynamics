...
```
sports2.ipynb               # Working notebook (15 cells, ~530KB with output data)
sports.ipynb                # Original notebook (kept for reference, ~666K lines)
```
...
| 7 | md | Module 2 intro — Knuckleball vs Magnus, same 8×4 domain |
| 8 | code | Module 2 simulation — two runs: ω=10 and ω=0, 120 steps each |
| 9 | code | Module 2 2-panel velocity+streamlines → `knuckleball_comparison.mp4` |
| 10 | code | Module 2 2-panel pressure comparison → `knuckleball_pressure.mp4` |
| 11 | md | Module 3 intro — Peloton drafting, 4×8 domain, 128×256 grid |
| 12 | code | Module 3 simulation — 3 cases (solo/inline/echelon), rectangles |
| 13 | code | Module 3 3-panel velocity animation → `wake_comparison.mp4` |
| 14 | code | Module 3 3-panel streamlines animation → `wake_streamlines.mp4` |
...
| Module 2 grid | 256 × 128 (8×4 domain) | Same as Module 1 (soccer ball cross-section) |
| Module 3 grid | 128 × 256 (4×8 domain) | Tall rectangle for drafting configuration |
...
├── sports2.ipynb              # Working notebook (15 cells)
├── assets/
